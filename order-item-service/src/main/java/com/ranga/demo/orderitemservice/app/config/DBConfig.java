package com.ranga.demo.orderitemservice.app.config;
...
@ComponentScan("com.ranga.demo.orderitemservice")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.ranga.demo.orderitemservice.domain")
